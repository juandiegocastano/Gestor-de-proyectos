 ...
 * @author Usuario
 */
public class PnlAñadirParticipanteCrearTarea extends javax.swing.JPanel implements AñadirParticipanteVisitador {
    ...
    public void cargarTablaParticipante() {{
        List<Integrante> integrantes = ControladorProyecto.getInstance().listarIntegrantesPorAgregarATareaCrearTarea(null,null,null);
